...
python summarize_reconstuction_exps.py --result-file-list pkl_path_1 pkl_path_2 --experiment-name-list scheme_1 scheme_2  --pose-name-list combo easy hard --result-file-name metrics.csv
