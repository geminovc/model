...
class DatasetWrapper(data.Dataset):
    ...
    def get_args(parser):
        ...
        parser.add('--root_to_diff_keypoints',  default='/data4/pantea/nets_implementation/original_bilayer/difficult_poses/results/difficult_poses/temp_per_person_extracts', type=str, 
