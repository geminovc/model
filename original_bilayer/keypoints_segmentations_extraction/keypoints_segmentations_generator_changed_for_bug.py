...
class keypoint_segmentation_generator(nn.Module):
    ...
    def preprocess_data(self, input_imgs, crop_data=True):
        ...
        for i in range(N):
            ...
            if input_imgs is None:
                ...
                if self.args.output_segmentation:
                    img_seg = img.resize((self.args.image_size, self.args.image_size), Image.BICUBIC)
                    imgs_segs.append((self.to_tensor(img_seg) - 0.5) * 2)
    ...
    def get_poses (self):
        ...
        while int(self.seq_id) < len(self.sequences):
            ...
            to_image_module(img_tensor)
            imgs = to_image_module(imgs)
            ...
            for i in range(0, number_of_poses):
                ...
                if pose is not None:
                    ...
                    if self.args.output_segmentation:
                        ...
                        segs = Image.fromarray((segs_t.cpu()).numpy())
