...
# The specific command I run is ./run_all.sh "source ~/.bashrc" "/data/vision/billf/video-conf/scratch/pantea/temp_per_person_1_extracts" "/data/vision/billf/video-conf/scratch/vedantha/temp_1_angles"
