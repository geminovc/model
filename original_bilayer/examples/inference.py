...
# parser.add_argument('--init_networks', default='', type=str, help='list of networks to intialize')
# parser.add_argument('--init_which_epoch', default='none', type=str, help='epoch to initialize from')
# parser.add_argument('--psnr_loss_apply_to', default='pred_target_delta_lf_rgbs , target_imgs', type=str, help='psnr loss to apply') 
