...
# These are the no-rebalanced versions of those above experiments but on vedantha
./unet_run_script.sh False "no_unet_from_base" "from_base" "vedantha" 2 10000 10 10 True True False

# Now from paper checkpoints
./unet_run_script.sh False "no_unet_from_paper_vedantha" "from_paper" "vedantha" 2 10000 10 10 True True False

# Now the hf input unet from base
./unet_run_script.sh True "hf_unet_from_base" "from_base" "vedantha" 2 10000 10 10 True True False "hf" 16 

# Hf input unet from paper
./unet_run_script.sh True "hf_unet_from_paper" "from_paper" "vedantha" 2 10000 10 10 True True False "hf" 16 

# Now the hf and lf input unet from base
./unet_run_script.sh True "hf_lf_unet_from_base_vedantha" "from_base" "vedantha" 2 10000 10 10 True True False "hf,\ lf" 19 

# Hf and lf input unet from paper
./unet_run_script.sh True "hf_lf_unet_from_paper_vedantha" "from_paper" "vedantha" 2 10000 10 10 True True False "hf,\ lf" 19 
