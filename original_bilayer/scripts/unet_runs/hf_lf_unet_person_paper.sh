cd ../../
python train.py \
    --experiment_name 'per_person_hf_lf_unet_paper_4' \
    ...
    --skip_test False \
    --skip_metrics False \
    --init_experiment_dir /data/vision/billf/video-conf/scratch/vedantha/runs/runs/per_person_hf_unet_paper_2 \
    --init_networks 'identity_embedder, texture_generator, keypoints_embedder, inference_generator, discriminator' \
    --init_which_epoch 275 \
